...
from mailing.views import (
    ...
    MailingAttemptsView, BlogCreateView
)
...
urlpatterns = [
    ...
    path('mailing/attempts/', MailingAttemptsView.as_view(), name='mailing_attempts'),
    ...
    path('attempts/', MailingAttemptsView.as_view(), name='attempts'),
